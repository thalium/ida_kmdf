...
def run_script(script: str):
    ...
    run_script = os.path.abspath(os.path.join(root_dir, "run_script.py"))
    ida_script = os.path.abspath(os.path.join(root_dir, "wdf", script))
...
def make_til():
    ...
    til_creator = os.path.abspath(
        os.path.abspath(os.path.join(root_dir, "wdf", "WdfTilCreator.py"))
    )
